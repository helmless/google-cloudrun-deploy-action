...
- uses: helmless/google-cloudrun-deploy-action@v0.1.0
  with:
    ...
    # The workload identity provider to use for authentication.
    #
    # Required: true
    # Default: ""

    service_account:
    # The optional service account to impersonate for authentication.
    #
    # Required: false
    # Default: ""
```
...
| `workload_identity_provider` | <p>The workload identity provider to use for authentication.</p> | `true` | `""` |
| `service_account` | <p>The optional service account to impersonate for authentication.</p> | `false` | `""` |
<!-- action-docs-inputs source="action.yaml" -->
